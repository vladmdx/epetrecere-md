...
| 5 | **trecută, cu o rezervă** | toate cele cinci parcursuri închise pe simulator — client→rezervare, partener→acceptare, negociere bidirecțională, planificator (checklist bifat + invitat adăugat) și căile de eșec. 14 defecte găsite și reparate. **Rezerva:** paritatea vizuală cu cabinetul web n-a fost verificată — cere o sesiune de browser, iar aceasta cere fie o parolă tastată, fie un token de sesiune trecut prin transcript. |
