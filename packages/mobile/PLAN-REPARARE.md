...
| 5 | **4 din 5 parcursuri** | client→rezervare, partener→acceptare, negociere bidirecțională și căile de eșec — toate închise pe simulator, cu 11 defecte găsite și reparate pe parcurs. Rămâne planificatorul pe fluxul complet (invitați + checklist bifat) și verificarea în cabinetul web. |
